# Design System — Living Calendar (v4: Gumroad-Inspired)
...
## Aesthetic Direction
- **Direction:** Bold Minimal Kitsch — 흑백 고대비에 핑크 포인트. Gumroad 레퍼런스.
- **Decoration level:** Bold — 큰 타이포, 키치한 캐릭터, 강한 컬러 포인트
- **Mood:** 심플하지만 재밌는. 깔끔하지만 개성 있는. 가시성 최우선.
- **Reference:** Gumroad (흑백+핑크, 볼드 타이포, 키치한 일러스트)
